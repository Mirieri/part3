...
import com.udacity.movie.part3.api.ApiResponse;
...
import com.udacity.movie.part3.utils.AbsentLiveData;
...
public class AppRepository implements AppRepositoryInterface {
    ...
    @Override
    public LiveData<com.udacity.movie.part3.utils.Resource<List<GenreEntity>>> loadGenres(List<Integer> genreIds) {
    ...
    @Override
    public LiveData<com.udacity.movie.part3.utils.Resource<List<MovieEntity>>> loadMovies(boolean forceLoad, String sortBy) {
    ...
    @Override
    public LiveData<com.udacity.movie.part3.utils.Resource<List<CastEntity>>> loadCast(int movieId) {
    ...
    @Override
    public LiveData<com.udacity.movie.part3.utils.Resource<List<VideoEntity>>> loadVideos(int movieId) {
    ...
    @Override
    public LiveData<com.udacity.movie.part3.utils.Resource<List<ReviewEntity>>> loadReviews(int movieId) {
